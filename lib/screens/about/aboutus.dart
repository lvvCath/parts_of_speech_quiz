...
class NumbersWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context)=> Row(
    ...
    children: <Widget>[
      buildButton(text: 'Reviews', value:'4.0',),
      buildDivider(),
      buildButton(text: 'Rated', value:'5+',),
      buildDivider(),
      buildButton(text: 'Downloads', value:'500',),
    ],
  );
...
class AboutUS extends StatelessWidget {
  ...
  Widget buildContent()=> Column(
    children: [
      ...
      const SizedBox(height: 8),
      Text('Mobile Learning Application',
        style: TextStyle(
          color: Colors.grey,
        ) ,
      ),
    ...
    child: Column(
      ...
      children: [
        ...
        Card(
          ...
          color: Colors.white60, // I want to make the card transparent but putting there is still a shadow so
